...
const PrivateDiningSection: React.FC = () => {
  return (
    <section className="bg-[#f9f7f2] pt-40 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full items-stretch">
        {/* Left Column: Image (Centred portrait with margin) */}
        <div className="flex items-center justify-center lg:justify-end lg:pr-32 px-12 py-24 lg:py-40 lg:pb-56">
          <div className="w-full max-w-sm aspect-[3.4/5] shadow-[30px_30px_80px_rgba(0,0,0,0.06)] relative overflow-hidden animate-[fade-in-left_2s_cubic-bezier(0.2,0.8,0.2,1)_forwards]">
            <img
              src="/new_interior_2025/PHOTO-2025-07-28-10-50-40.jpg"
              alt="Dining at The Olive Tree"
        ...
        <div className="bg-[#53663e] flex items-center justify-center relative shadow-[-20px_0_50px_rgba(0,0,0,0.1)] animate-[fade-in-right_2s_cubic-bezier(0.2,0.8,0.2,1)_forwards] px-12 py-32 lg:py-40">

          {/* Decorative Corner Frame */}
          <div className="absolute inset-8 md:inset-16 pointer-events-none">
            <svg className="w-full h-full text-white/20" viewBox="0 0 600 480" fill="none" stroke="currentColor" strokeWidth="1">
              <path
              ...
              <circle cx="595" cy="5" r="1.5" fill="currentColor" stroke="none" />
              <circle cx="5" cy="475" r="1.5" fill="currentColor" stroke="none" />
              <circle cx="595" cy="475" r="1.5" fill="currentColor" stroke="none" />
            </svg>
          </div>
          ...
          <div className="max-w-md text-center space-y-12 relative z-10">
            ...
            <h3 className="text-4xl md:text-5xl lg:text-[4rem] serif text-white leading-[1.05] font-light">
              Celebrate at <br />
              <span className="italic">The Olive Tree</span>
            </h3>

            <p className="text-white/80 text-sm md:text-base font-light leading-relaxed max-w-sm mx-auto opacity-80">
              ...
              <a href="#" className="group/link inline-flex items-center text-white space-x-12">
                ...
                <div className="flex items-center">
                  ...
                  <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 ml-3 transform group-hover/link:translate-x-4 transition-transform duration-[800ms] cubic-bezier(0.4, 0, 0.2, 1)">
                    <path d="M17 12L12 7M17 12L12 17M17 12H3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </a>
            </div>
