...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
      ...
      <div 
        className="absolute inset-0 z-0 scale-105 animate-[subtle-zoom_20s_infinite_alternate]"
        style={{
      ...
      {/* Decorative Ornaments (Ivy Style) */}
      ...
      {/* Hero Content */}
      <div className="relative z-20 text-center px-6 max-w-4xl opacity-0 animate-[fade-in-up_1s_ease-out_forwards]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="group relative px-10 py-4 bg-[#53663e] text-white text-[11px] uppercase tracking-[0.2em] font-bold overflow-hidden transition-all duration-300 rounded-sm">
            <span className="relative z-10">Book a Table</span>
            <div className="absolute inset-0 bg-white/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
          </button>
          
          <button className="group flex items-center space-x-2 text-white text-[11px] uppercase tracking-[0.2em] font-bold border-b border-white/30 pb-1 hover:border-white transition-all">
